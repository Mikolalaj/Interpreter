...
"""
    ...
    def testIdentifierWithUnderscore(self):
        ...
        assert tokens[5] == IdentifierValueToken(startPosition=Position(line=2, column=5), length=2, value="_a_")
        ...
        assert tokens[9] == IdentifierValueToken(startPosition=Position(line=3, column=5), length=2, value="_a_1")
        ...
        assert tokens[13] == IdentifierValueToken(startPosition=Position(line=4, column=5), length=2, value="_a_1_")
        ...
        assert tokens[17] == IdentifierValueToken(startPosition=Position(line=5, column=5), length=2, value="a_1_")
