...
class TestIf:
    ...
    def testSingleIfNoSpaces(self):
        ...
        assert len(lexer.allTokens) == 11
        assert lexer.allTokens[0] == Token(type=TokenType.T_IF, startPosition=Position(line=1, column=1), length=2)
        assert lexer.allTokens[1] == Token(type=TokenType.T_LPARENT, startPosition=Position(line=1, column=3), length=1)
        assert lexer.allTokens[2] == IdentifierValueToken(startPosition=Position(line=1, column=4), length=1, value="a")
        assert lexer.allTokens[3] == Token(type=TokenType.T_GREATER, startPosition=Position(line=1, column=5), length=1)
        assert lexer.allTokens[4] == IntValueToken(value=3, startPosition=Position(line=1, column=6), length=1)
        assert lexer.allTokens[5] == Token(type=TokenType.T_RPARENT, startPosition=Position(line=1, column=7), length=1)
        assert lexer.allTokens[6] == Token(type=TokenType.T_LBRACKET, startPosition=Position(line=1, column=8), length=1)
        assert lexer.allTokens[7] == IdentifierValueToken(startPosition=Position(line=1, column=9), length=1, value="a")
        assert lexer.allTokens[8] == Token(type=TokenType.T_ASSIGN, startPosition=Position(line=1, column=10), length=1)
        assert lexer.allTokens[9] == IntValueToken(value=0, startPosition=Position(line=1, column=11), length=1)
        assert lexer.allTokens[10] == Token(type=TokenType.T_RBRACKET, startPosition=Position(line=1, column=12), length=1)
    ...
    def testIfElif(self):
        ...
        assert lexer.allTokens[1] == Token(type=TokenType.T_LPARENT, startPosition=Position(line=1, column=4), length=1)
        assert lexer.allTokens[2] == IdentifierValueToken(startPosition=Position(line=1, column=6), length=1, value="a")
        assert lexer.allTokens[3] == Token(type=TokenType.T_LESS, startPosition=Position(line=1, column=8), length=1)
        ...
        assert lexer.allTokens[10] == Token(type=TokenType.T_MINUS, startPosition=Position(line=2, column=11), length=1)
        assert lexer.allTokens[11] == IntValueToken(value=1, startPosition=Position(line=2, column=13), length=1)
        assert lexer.allTokens[12] == Token(type=TokenType.T_RBRACKET, startPosition=Position(line=3, column=1), length=1)
        assert lexer.allTokens[13] == Token(type=TokenType.T_ELSEIF, startPosition=Position(line=3, column=3), length=4)
        assert lexer.allTokens[14] == Token(type=TokenType.T_LPARENT, startPosition=Position(line=3, column=8), length=1)
        assert lexer.allTokens[15] == IdentifierValueToken(startPosition=Position(line=3, column=10), length=1, value="a")
        assert lexer.allTokens[16] == Token(type=TokenType.T_LESS, startPosition=Position(line=3, column=12), length=1)
        assert lexer.allTokens[17] == IntValueToken(startPosition=Position(line=3, column=14), length=1, value=3)
        assert lexer.allTokens[18] == Token(type=TokenType.T_RPARENT, startPosition=Position(line=3, column=16), length=1)
        assert lexer.allTokens[19] == Token(type=TokenType.T_LBRACKET, startPosition=Position(line=3, column=18), length=1)
        assert lexer.allTokens[20] == IdentifierValueToken(startPosition=Position(line=4, column=5), length=1, value="a")
        assert lexer.allTokens[21] == Token(type=TokenType.T_ASSIGN, startPosition=Position(line=4, column=7), length=1)
        assert lexer.allTokens[22] == IntValueToken(value=1, startPosition=Position(line=4, column=9), length=1)
        assert lexer.allTokens[23] == Token(type=TokenType.T_RBRACKET, startPosition=Position(line=5, column=1), length=1)
    ...
    def testIfElse(self):
        ...
        assert lexer.allTokens[0] == Token(type=TokenType.T_IF, startPosition=Position(line=1, column=1), length=2)
        assert lexer.allTokens[1] == Token(type=TokenType.T_LPARENT, startPosition=Position(line=1, column=4), length=1)
        assert lexer.allTokens[2] == Token(type=TokenType.T_RPARENT, startPosition=Position(line=1, column=5), length=1)
        assert lexer.allTokens[3] == Token(type=TokenType.T_LBRACKET, startPosition=Position(line=1, column=7), length=1)
        assert lexer.allTokens[4] == Token(type=TokenType.T_RBRACKET, startPosition=Position(line=2, column=1), length=1)
        assert lexer.allTokens[5] == Token(type=TokenType.T_ELSE, startPosition=Position(line=2, column=3), length=4)
        assert lexer.allTokens[6] == Token(type=TokenType.T_LPARENT, startPosition=Position(line=2, column=8), length=1)
        assert lexer.allTokens[7] == Token(type=TokenType.T_RPARENT, startPosition=Position(line=2, column=9), length=1)
        assert lexer.allTokens[8] == Token(type=TokenType.T_LBRACKET, startPosition=Position(line=2, column=11), length=1)
        assert lexer.allTokens[9] == Token(type=TokenType.T_RBRACKET, startPosition=Position(line=3, column=1), length=1)
